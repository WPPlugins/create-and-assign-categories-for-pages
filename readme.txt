...
3. Now click on "Pages" from your dashboard and click on categories, create new category here.
4. You can now add Categories to the Pages just like you do it for your Posts.
5. Now you can get the pages with specific category with the help of query post/wp_query.
6. Enjoy.
...
The FAQ section will be updated in next release of the plugin. 
